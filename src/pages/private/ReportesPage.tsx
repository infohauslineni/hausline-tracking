...
export function ReportesPage() {
  ...
  return <div>
    ...
    <section className="mt-8"><div><p className="eyebrow">Análisis</p><h2 className="page-title text-xl!">Operaciones de la semana</h2><p className="page-subtitle">Ventas, flujo de dinero y pedidos por etapa (movido aquí desde el Resumen).</p></div><OperacionesCharts /></section>
