...
export function NuevoPedidoPage() {
  ...
  const submit = async (values: FormValues) => {
    try {
      ...
      const ventaTotal = facturaItems.reduce((sum, item) => sum + item.cantidad * item.precio, 0)
      setFactura({
