...
export type CuentaBancaria = { id: string; nombre: string; banco: string | null; numero: string | null; titular: string | null; moneda: Moneda; emoji: string; saldo: number; orden: number; activo: boolean; proposito: PropositoCuenta; limite: number | null; mostrar_clientes?: boolean; created_at: string; updated_at: string }
...
export type Inversion = { id: string; fecha: string; producto_id: string | null; codigo: string | null; producto: string; marca: string | null; talla_color: string | null; cantidad: number; costo_unitario: number; gastos_adicionales: number; precio_venta_estimado: number; estado: 'en_transito' | 'en_inventario' | 'reservado' | 'vendido' | 'descartado'; pagado?: boolean; pagado_at?: string | null; notas: string | null; imagen?: string | null; tracking?: string | null; transportista?: string | null; url_tracking?: string | null; estado_tracking?: string | null; pedido_id?: string | null; created_at: string; productos?: Pick<Producto, 'nombre' | 'codigo'> | null; gastos?: Pick<Gasto, 'id' | 'monto' | 'categoria'>[]; pedidos?: { codigo: string } | null }
