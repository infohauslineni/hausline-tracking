...
export type MovimientoCuenta = { id: string; fecha: string; tipo: 'ingreso' | 'retiro' | 'pago_proveedor' | 'gasto' | 'inversion' | 'ajuste_entrada' | 'ajuste_salida'; descripcion: string; monto: number; moneda?: Moneda; monto_original?: number | null; tipo_cambio?: number | null; metodo: string | null; pedido_id: string | null; observaciones: string | null; created_at: string; pedidos?: Pick<Pedido, 'codigo'> | null }
