...
export type PublicImage = { tipo: 'producto' | 'control_calidad' | 'comprobante' | 'entrega' | 'recepcion_miami' | 'recibido_local' | 'recibido_hausline' | 'empaque'; nombre: string; storage_path: string; orden: number; url?: string }
